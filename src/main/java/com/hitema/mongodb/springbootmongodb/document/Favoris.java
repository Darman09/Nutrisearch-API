...
public class Favoris {
    ...
    public Favoris(String id, String product_name_fr, String nutrition_grades, String packaging, String manufacturing_places, String countries, String categories, String ingredients_text_with_allergens_fr, String quantity) {
        this.id = id;
